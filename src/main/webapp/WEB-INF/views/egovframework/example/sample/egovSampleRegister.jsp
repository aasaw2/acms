...
<head>
    ...
    <script type="text/javascript" src="<c:url value='/cmmn/validator.ap'/>"></script>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_delete() {
           	document.detailForm.action = "<c:url value='/deleteSample.ap'/>";
           	document.detailForm.submit();
        }
        ...
        /*	if(!validateSampleVO(frm)){
            	...
            	frm.action = "<c:url value="${registerFlag == 'create' ? '/addSample.ap' : '/updateSample.ap'}"/>";
                frm.submit();
            //}
        }
