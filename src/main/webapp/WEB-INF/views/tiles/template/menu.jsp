        ...
        <div class="sidebar-nav ">
            <ul class="nav" id="side-menu">
                ...
                <c:forEach var="lm" items="${sessionScope.leftMenu}" varStatus="status">
                    <li>
                        <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> ${lm.menuName}
                        ...
                        <c:forEach var="lmd" items="${lm.menuDetails}" varStatus="status">
                            ...
                            <li>
                                <a href="${lmd.menuSubLink}"> ${lmd.menuSubName}</a>
                            </li>
                            <c:if test="${status.count == fn:length(lm.menuDetails)}">
                                </ul>
                            </c:if>
                        </c:forEach>
                    </li>
