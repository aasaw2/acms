            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped" id="codeListTable">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>코드 그룹 ID</th>
                            ...
                            <tbody>
                            <c:forEach var="result" items="${codeList.content}" varStatus="status">
                                <tr id="update_${result.id}" idx="${result.id}">
                                    <td>
                                            ${codeList.totalElements - (codeList.size * codeList.number ) - status.index }
                                    </td>
                                    <td><c:out value="${result.codeGroupId}"/></td>
                                    <td><c:out value="${result.codeGroupName}"/></td>
                                </tr>
                            </c:forEach>

                            <c:if test="${codeList.totalElements == 0}" >
                                <tr>
                    ...
                    <!-- /.table-responsive -->
                    <input id="codeSave" class="btn btn-lg btn-success btn-block" type="button" value="등록" />
                </div>
                <!-- /.panel-body -->
            </div>
            <!-- /.panel -->
...
<script>
    $( "#codeSave" ).click(function() {
        location.href="/admin/code/write";
    });
    ...
    $("#codeListTable tr").click(function() {
        ...
        location.href="/admin/code/update/"+tr.attr("idx");
    });
