...
<div id="page-wrapper">
    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">리스트 게시판 형</h1>
        </div>
    </div>
...
<%--                                               value="편집"/></td>--%>
                    ...
                    <!-- /.table-responsive -->
                    <input id="boardContentSave" class="btn btn-lg btn-success btn-block" type="button" value="등록"/>
                </div>
                <!-- /.panel-body -->
            </div>
            <!-- /.panel -->
...
<script>
    $("#boardContentSave").on('click', function (e) {
        window.location.href = "/admin/board/${board.id}/content";
    })

    $("#boardListTable tr").click(function() {
        alert("click");
        // var str = "";
