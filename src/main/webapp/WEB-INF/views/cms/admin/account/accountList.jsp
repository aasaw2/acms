            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">table-responsive
                        <table class="table table-bordered table-hover" id="accountListTable">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>이메일주소</th>
                           ...
                           <c:forEach var="result" items="${resultList.content}" varStatus="status">
                                <tr id="update_${result.id}" idx="${result.id}">
                                    ...
                                    <td><c:out value="${result.accountName}"/></td>
                                </tr>
                            </c:forEach>
                    ...
                    <!-- /.table-responsive -->
                        <input id="accountSave" class="btn btn-lg btn-success btn-block" type="button" value="등록" />
                </div>
                <!-- /.panel-body -->
            </div>
            <!-- /.panel -->
...
<script>
    $( "#accountSave" ).click(function() {
        location.href="/admin/Account/JoinMember";
    });
    ...
    //   console.log("클릭한 Row의 모든 데이터 : "+tr.text());
     ...
     //   console.log("배열에 담긴 값 : "+tdArr);
      ...
      location.href="/admin/Account/update/"+tr.attr("idx");
    });
