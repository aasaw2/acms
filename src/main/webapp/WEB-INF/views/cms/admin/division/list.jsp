            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover table-striped" id="divisionListTable">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>부서 코드</th>
                    ...
                    <!-- /.table-responsive -->
                        <input id="divisionSave" class="btn btn-lg btn-success btn-block" type="button" value="등록" />
                </div>
                <!-- /.panel-body -->
            </div>
            <!-- /.panel -->
...
<script>
    $( "#divisionSave" ).click(function() {
        location.href="/admin/Division/write";
    });
    ...
    //   console.log("클릭한 Row의 모든 데이터 : "+tr.text());
     ...
     //   console.log("배열에 담긴 값 : "+tdArr);
      ...
      location.href="/admin/Division/update/"+tr.attr("idx");
    });
